...
export function SpiralIcon({ size = 24, className }: SpiralIconProps) {
  return (
    ...
    >
      ...
      <circle cx="60" cy="60" r="14"  fill="#1e1e35"/>
      <circle cx="60" cy="60" r="11"  fill="#c8a84b" opacity="0.35"/>
      <circle cx="60" cy="60" r="7"   fill="#d4b85a" opacity="0.75"/>
      <circle cx="60" cy="60" r="3.5" fill="#e8d090" opacity="0.98"/>
    </svg>
  )
}
